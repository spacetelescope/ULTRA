...
from ultra.util import matrix_subsample, calculate_sensitivity_matrices
...
if __name__ == '__main__':
    ...
    run_matrix = MatrixEfieldLuvoirA(which_dm=WHICH_DM, dm_spec=DM_SPEC, calc_science=True,
                                     calc_wfs=True, calc_lowfs=calc_lowfs,
    ...
    mat_wfs = np.dot(np.transpose(g_wfs_flat), g_wfs_flat)  # / np.sum(tel.dh_mask)
