...
from pastis.matrix_generation.matrix_from_efields import MatrixEfieldLuvoirA_lowfs
...
if __name__ == '__main__':
    ...
    DM_SPEC = 15
    NUM_MODES = 15
    run_matrix = MatrixEfieldLuvoirA_lowfs(which_dm=WHICH_DM, dm_spec=DM_SPEC,
