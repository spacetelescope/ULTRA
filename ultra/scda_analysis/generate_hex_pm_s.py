"""
This module generates dynamic surface tolerance map for L3 harris mode, if using this as a launcher script, save the
the data generated by harris_mode.py to the disk, enter the <path-to-data> in config's local_data_path.
"""
