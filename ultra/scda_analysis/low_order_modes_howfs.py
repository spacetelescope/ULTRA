...
if __name__ == '__main__':
    ...
    for wavescale in wavescaleVec:
        ...
        for tscale in np.logspace(TimeMinus, TimePlus, Ntimes):
            ...
            print(tscale)
            # with Lowfs
            tmp0 = req_closedloop_calc_recursive(g_coron, g_wfs, e0_coron, e0_wfs, detector_noise,
    ...
    np.savetxt(os.path.join(data_dir, 'contrast_wf_%s_%d_%d_%d.csv' % (C_TARGET, WaveScaleMinus, WaveScalePlus, Nwavescale)),
